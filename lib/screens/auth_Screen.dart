...
class _AuthCardState extends State<AuthCard> {
  ...
  void errorBox(String error){
    showDialog(context: context, builder: (ctx)=>AlertDialog(
      title: Text("Ooops",style: TextStyle(
        color: Colors.red,
  ...
  Future<void> _submit() async{
    ...
    try{
      if (_authMode == AuthMode.Login) {
        await Provider.of<Auth>(context,listen: false).login(_authData["email"], _authData["password"], _authData["userName"]) ; // Log user in
      } else {
      ...
      var errorMessage="would not Authinticate you";
      errorBox(errorMessage);
    }

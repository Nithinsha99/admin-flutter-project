...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void _saveForm(){
    ...
    if(editproductScreen.id!=null){
      Provider.of<Products>(context,listen: false).updateItem(editproductScreen.id, editproductScreen);
      setState(() {
        _lodingScreen=false;
      ...
      Provider.of<Products>(context,listen: false).addItem(editproductScreen).then((_) {
        setState(() {
          _lodingScreen=false;
        });
        Navigator.of(context).pop();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:_lodingScreen?Center(child: CircularProgressIndicator()): Form(
        key: formKey,
        child: Padding(
